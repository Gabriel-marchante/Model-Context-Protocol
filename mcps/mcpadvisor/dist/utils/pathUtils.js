 ...
 * @returns 当前文件的绝对路径
 */
export function getFilePath(metaUrl = null) {
    // 在 Jest 环境中使用工作目录
 ...
 */
export function getDirPath(metaUrl = null) {
 ...
 * @returns 项目根目录的绝对路径
 */
export function getProjectRootPath(metaUrl = null, levelsUp = 0) {
 ...
 * @returns 数据目录的绝对路径
 */
export function getDataDirPath(metaUrl = null) {
 ...
 */
export function getMcpServerListPath(metaUrl = null) {
 ...
 * @returns 包内文件的绝对路径
 */
export function getNodeModulesPath(packageName, relativePath) {

 ...
 */
function normalizeItem(item, fieldMap) {
    const normalized = {};
 ...
 */
async function fetchFromSources(sources, fetchFn) {
 ...
 */
export async function loadAll(additionalSources, additionalFieldMap) {
 ...
 */
export async function addAdditionalSources(sources, fieldMap) {

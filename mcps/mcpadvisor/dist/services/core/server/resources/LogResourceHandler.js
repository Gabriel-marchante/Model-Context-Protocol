...
export class LogResourceHandler extends BaseResourceHandler {
    ...
    resourceCache = null;
    CACHE_TTL_MS = parseInt(process.env.RESOURCE_CACHE_TTL || '30000'); // 30 seconds default
    constructor() {
        super();
     ...
     */
    async addResourcesFromDirectory(directory, resources) {
        try {
     ...
     */
    createResourceFromFile(directory, filename) {

...
import { FailoverMeilisearchClient } from '../../providers/meilisearch/controller.js';
import logger from '../../../utils/logger.js';
/**
 * 将 GetMCP API 响应转换为 Meilisearch 文档
 */
const convertToMeilisearchDocuments = (data) => Object.entries(data).map(([id, server]) => ({
    id,
 ...
 */
const convertHitToServerResponse = (hit) => ({
    id: hit.id,
    title: hit.title,
...
export class MeilisearchSearchProvider {
     ...
     * 构造函数
     */
    constructor(resourceFetcher, cache, client) {

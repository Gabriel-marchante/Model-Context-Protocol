 ...
 * MCP客户端类型
 */
export var McpClientType;
(function (McpClientType) {
    McpClientType["CLAUDE"] = "claude";
    McpClientType["CLAUDE_DESKTOP"] = "claude desktop";
    McpClientType["WINDSURF"] = "windsurf";
    McpClientType["CASCADE"] = "cascade";
    McpClientType["CURSOR"] = "cursor";
    McpClientType["CLINE"] = "cline";
    McpClientType["CHATGPT"] = "chatgpt";
    McpClientType["OPENAI"] = "openai";
    McpClientType["OTHER"] = "other";
...
export class ConfigurationGuideService {
     ...
     * @returns 配置指南文本
     */
    generateConfigurationGuide(mcpName, mcpClient = '') {
        ...
        return `
{
  "mcpServers": {
     ...
     * @returns 配置指南文本
     */
    getClaudeConfigGuide(mcpName, baseConfigTemplate) {

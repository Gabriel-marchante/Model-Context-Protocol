...
public class McpController {
    ...
    public Object saveServer(Map<String, Object> payload) {
        ...
        try {
            ...
            return Map.of(
                    ...
                    "probe", probe,
                    "message",
                    "Servidor validado y guardado en tu workspace. Cuando acabes, aplica la configuracion para generar o actualizar tu runtime declarativo.",
    ...
    public Object executeTool(Map<String, Object> payload) {
        return Map.of(
                "error",
                "La ejecucion directa de tools no esta disponible desde control-plane. Usa el chat del workspace runtime una vez aplicado y arrancado.");
    }
    ...
    public Object chatWithAgent(Map<String, Object> payload) {
        ...
        java.util.List<java.util.Map<String, String>> attachments = (java.util.List<java.util.Map<String, String>>) payload
                .get("attachments");

        boolean hasContent = (userMessage != null && !userMessage.isBlank())
                || (attachments != null && !attachments.isEmpty());
        if (!hasContent) {
            return Map.of("error", "El mensaje es obligatorio.");
        }
        return workspaceChatProxyService.chat(currentUserId(), userMessage == null ? "" : userMessage, attachments);
    }
